...
(authService.getCurrentUserEmail as jest.Mock).mockResolvedValue('admin@test.com');
(authService.getCurrentUserName as jest.Mock).mockResolvedValue('Admin User');
(authService.getCurrentUserRoles as jest.Mock).mockResolvedValue(['Administrators']);
