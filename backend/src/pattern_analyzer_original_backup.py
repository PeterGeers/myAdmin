...
class PatternAnalyzer:
    ...
    def _analyze_reference_patterns(self, transactions: List[Dict], administration: str) -> Dict[str, Any]:
        ...
        for tx in transactions:
            ...
            # FIX #1: Use verb_company only, not compound verb with reference
            ...
            verb_patterns[pattern_key] = {
                ...
                'verb': verb_company,  # FIX #1: Store company only, not compound
    ...
    def _extract_company_name(self, description: str) -> Optional[str]:
        ...
        # FIX #2: Allow digits at start of company names (e.g., "2Theloo", "123Inkt")
        ...
        for word in words:
            ...
            # FIX #3: Increase length limit from 15 to 25 characters
            ...
            # FIX #4: Allow acronyms (3-5 uppercase letters) even without vowels (e.g., "SVB", "KPN", "NS")
