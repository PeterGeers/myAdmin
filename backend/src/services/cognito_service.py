...
class CognitoService:
    ...
    def create_group(self, name: str, description: str = "") -> Dict:
        ...
        try:
            response = self.client.create_group(
                UserPoolId=self.user_pool_id, GroupName=name, Description=description
            )
    ...
    def update_group(
        ...
        """
        try:
            params = {"UserPoolId": self.user_pool_id, "GroupName": name}
    ...
    def get_group_user_count(self, group_name: str) -> int:
        ...
        try:
            response = self.client.list_users_in_group(
                UserPoolId=self.user_pool_id, GroupName=group_name, Limit=60
            )
