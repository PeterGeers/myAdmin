...
class ZZPInvoiceDeliveryHelper:
    ...
    def __init__(self, db, parameter_service=None, booking_helper=None,
                 pdf_generator=None, email_service=None) -> None:
        self.db = db
    ...
    def send_invoice(self, tenant: str, invoice_id: int, options: dict,
                     get_invoice_fn, output_service=None) -> dict:
    ...
    def get_invoice_pdf(self, tenant: str, invoice_id: int,
                        get_invoice_fn) -> Optional[dict]:
    ...
    def get_email_preview(self, tenant: str, invoice_id: int,
                          get_invoice_fn) -> dict:
