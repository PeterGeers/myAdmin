        ...
        try:
            ...
            for key, value in flat_settings.items():
                ...
                self.db.execute_query(
                    query, (administration, key, value_str), fetch=False, commit=True
                )
        ...
        try:
            ...
            try:
                ...
                results = self.db.execute_query(
                    query, (administration, start_date, end_date)
                )
                ...
                activity_stats["actions_by_type"] = {
                    row["action_type"]: row["count"] for row in results
                }
                ...
                activity_stats["actions_by_user"] = {
                    row["user_email"]: row["count"] for row in results
                }
