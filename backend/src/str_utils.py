...
def calculate_str_taxes(gross_amount: float, checkin_date: str, channel_fee: float = 0.0,
                        tax_rate_service=None, tenant: str = None) -> dict:
    """
    ...
    try:
        ...
        return {
            ...
            'tax_rates_used': get_tax_rates(datetime.now().strftime('%Y-%m-%d'), tax_rate_service, tenant),
