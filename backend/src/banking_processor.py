...
class BankingProcessor:
    ...
    def read_rabo_csv(self, file_path):
        ...
        try:
            ...
            if (
                "TransactionAmount" in standard_columns
                and not standard_columns["TransactionAmount"].empty
            ):
    ...
    def read_generic_csv(self, file_path):
        ...
        try:
            ...
            amount_col = self.find_column(
                df, ["amount", "bedrag", "transaction_amount"]
            )
    ...
    def check_banking_accounts(self, end_date=None, administration=None):
        ...
        return self._checks.check_banking_accounts(
            end_date=end_date, administration=administration
        )
    ...
    def analyze_patterns_for_administration(
        self,
        administration,
        ...
        try:
            ...
            print(
                f"   - Date range: {patterns['date_range']['from']} to {patterns['date_range']['to']}"
            )
    ...
    def apply_enhanced_patterns(self, transactions, administration):
        ...
        try:
            print(
                f"🔧 Applying enhanced patterns to {len(transactions)} transactions..."
            )

            if hasattr(transactions, "to_dict"):
                transactions = transactions.to_dict("records")

            updated_transactions, results = (
                self.pattern_analyzer.apply_patterns_to_transactions(
            ...
            print(
                f"   - Reference predictions: {results['predictions_made']['reference']}"
            )
