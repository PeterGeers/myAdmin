...
@tenant_admin_template_ai_bp.route('/api/tenant-admin/templates/apply-ai-fixes', methods=['POST'])
@cognito_required(required_permissions=[])
...
@tenant_admin_template_ai_bp.route('/api/tenant-admin/templates/<template_type>', methods=['DELETE'])
@cognito_required(required_permissions=[])
