            ...
            <TabPanel>
              <VStack spacing={4} align="stretch">
                ...
                <Stack spacing={4} direction={{ base: 'column', lg: 'row' }} align="start">
                  ...
                  <Card bg="gray.700">
                    <CardHeader>
                      <Heading size="md" color="white">Balance Sheet</Heading>
                    </CardHeader>
                  <CardBody>
                    <Box maxW="400px">
                      <TableContainer maxH="500px" overflowY="auto">
                  ...
                  <CardBody>
                    <HStack spacing={4} wrap="wrap">
                      <VStack spacing={1}>
                        ...
                        <Input
                          type="date"
                          value={balanceFilters.dateFrom || new Date(new Date().getFullYear(), 0, 1).toISOString().split('T')[0]}
