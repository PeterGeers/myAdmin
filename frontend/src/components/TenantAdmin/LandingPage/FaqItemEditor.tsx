 ...
 *
 * Allows add/edit/remove/reorder of FAQ question-answer pairs.
 * Items are collapsed by default and expand on click to edit.
    ...
    <VStack spacing={3} align="stretch">
      ...
      {items.length === 0 ? (
        <Text color="gray.500" fontSize="xs" fontStyle="italic">
          {t('landingPage.faqEditor.noItems')}
        </Text>
      ) : (
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              >
                ...
                >
                  {item.question || t('landingPage.faqEditor.untitledQuestion')}
                </Text>
              ...
              <Collapse in={expandedIndex === index} animateOpacity>
                <VStack spacing={2} px={3} pb={3} align="stretch">
                  ...
                  <HStack spacing={1} justify="flex-end">
                    ...
                    />
                    <IconButton
                      aria-label={t('landingPage.faqEditor.removeItem')}
                      icon={<DeleteIcon />}
                      size="xs"
                      variant="ghost"
                      color="red.400"
      ...
      >
        {t('landingPage.faqEditor.addItem')}
      </Button>
        ...
        <AlertDialogOverlay>
          <AlertDialogContent bg="gray.800" borderColor="gray.600">
            <AlertDialogHeader fontSize="md" color="white">
              {t('landingPage.faqEditor.removeTitle')}
            </AlertDialogHeader>
            <AlertDialogBody color="gray.300" fontSize="sm">
              {t('landingPage.faqEditor.removeConfirm')}
            </AlertDialogBody>
            <AlertDialogFooter>
