...
export const InvoiceLineEditor: React.FC<InvoiceLineEditorProps> = ({
  ...
  return (
    <>
      {/*
        Scrollable region for the line-items table. Vertical scroll keeps a
        long list of lines within a bounded height so the pinned action bar and
        totals stay visible; horizontal scroll keeps the wide table usable on
        narrow (mobile) screens. maxH is responsive: smaller on mobile.
      */}
      <Box
        data-testid="invoice-lines-scroll"
