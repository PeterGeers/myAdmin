Continuous failures to impement the language model 
Over 2000 lines of code
Different modules in scope
-- Import of banking accounts (Rabo, Revolut)
-- Transactions overview plus edit modal
