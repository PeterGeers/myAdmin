...
- [ ] 1. Database schema and backend foundation
  - [ ] 1.1 Create database migration script for budget tables
  ...
  - [ ] 1.2 Create TypeScript type definitions (`frontend/src/types/budget.ts`)
  ...
  - [ ] 1.3 Create budget service module (`backend/src/services/budget_service.py`)
...
- [ ] 2. Budget Version Management
  - [ ] 2.1 Implement version CRUD in budget service
  ...
  - [ ] 2.2 Implement status transitions in budget service
  ...
  - [ ] 2.3 Implement version activation in budget service
  ...
  - [ ] 2.4 Create budget version routes (`backend/src/routes/budget_routes.py`)
  ...
  - [ ]\* 2.5 Write property tests for status transitions and active version uniqueness
...
- [ ] 3. Budget Template Management
  - [ ] 3.1 Implement template CRUD in budget service
  ...
  - [ ] 3.2 Create budget template routes in `budget_routes.py`
  ...
  - [ ]\* 3.3 Write unit tests for template validation logic
...
- [ ] 4. Budget Line Entry
  - [ ] 4.1 Implement budget line CRUD in budget service
  ...
  - [ ] 4.2 Create budget line routes in `budget_routes.py`
  ...
  - [ ]\* 4.3 Write property test for annual division
...
- [ ] 6. Draft Generation and Budget Copy
  - [ ] 6.1 Implement draft generation in budget service
  ...
  - [ ] 6.2 Implement budget copy in budget service
  ...
  - [ ] 6.3 Create draft generation and copy routes in `budget_routes.py`
  ...
  - [ ]\* 6.4 Write property tests for annualization and copy
...
- [ ] 7. Dashboard and Hierarchy Rollup
  - [ ] 7.1 Implement hierarchy rollup in budget service
  ...
  - [ ] 7.2 Implement dashboard comparison in budget service
  ...
  - [ ] 7.3 Create dashboard route in `budget_routes.py`
  ...
  - [ ]\* 7.4 Write property tests for rollup and variance
...
- [ ] 9. Frontend API Service and Budget Versions Page
  - [ ] 9.1 Create frontend budget API service (`frontend/src/services/budgetService.ts`)
  ...
  - [ ] 9.2 Create BudgetVersionsPage (`frontend/src/pages/BudgetVersionsPage.tsx`)
  ...
  - [ ]\* 9.3 Write unit tests for BudgetVersionsPage
...
- [ ] 10. Frontend Templates and Lines Pages
  - [ ] 10.1 Create BudgetTemplatesPage (`frontend/src/pages/BudgetTemplatesPage.tsx`)
  ...
  - [ ] 10.2 Create BudgetLinesPage (`frontend/src/pages/BudgetLinesPage.tsx`)
  ...
  - [ ]\* 10.3 Write unit tests for BudgetLinesPage
    - Test monthly vs annual input mode switching
    - Test generate draft modal form
    - _Requirements: 3.1, 3.2_

- [ ] 11. Frontend Dashboard
  - [ ] 11.1 Create BudgetDashboard (`frontend/src/pages/BudgetDashboard.tsx`)
  ...
  - [ ]\* 11.2 Write unit tests for BudgetDashboard
...
- [ ] 12. Frontend routing and navigation integration
  - [ ] 12.1 Register budget pages in application router and navigation
...
- [ ] 13. Tenant isolation enforcement
  - [ ] 13.1 Add tenant isolation guards to all budget service methods
...
- [ ] 14. AI-Powered Budget Features (Backend)
  - [ ] 14.1 Create BudgetAIService (`backend/src/services/budget_ai_service.py`)
    - Implement class following `AITemplateAssistant` pattern: model fallback chain, usage tracking, timeout handling
    - Implement `_call_openrouter(system_prompt, user_prompt, administration, max_tokens, timeout)` shared helper
    - Implement graceful degradation: return structured error if API key missing or all models fail
    - _Requirements: 9.3, 9.4, 10.4, 11.5_

  - [ ] 14.2 Implement narrative generation in BudgetAIService
  ...
  - [ ] 14.3 Implement natural language query translation in BudgetAIService
  ...
  - [ ] 14.4 Implement draft adjustment suggestions in BudgetAIService
  ...
  - [ ] 14.5 Implement template recommendations in BudgetAIService
  ...
  - [ ] 14.6 Create AI routes in `budget_routes.py`
  ...
  - [ ]\* 14.7 Write unit tests for BudgetAIService
...
- [ ] 15. AI-Powered Budget Features (Frontend)
  - [ ] 15.1 Add AI actions to BudgetDashboard
  ...
  - [ ] 15.2 Add AI actions to BudgetLinesPage
  ...
  - [ ] 15.3 Add AI actions to BudgetTemplatesPage
...
- AI features (tasks 14–15) follow the existing `AITemplateAssistant` pattern: model fallback chain, usage tracking, graceful degradation
- AI calls are user-initiated only — no automatic/background calls, keeping costs near zero
- AI service uses free models first (Gemini Flash, Llama), falling back to cheap (DeepSeek) then paid (Claude) only if needed
